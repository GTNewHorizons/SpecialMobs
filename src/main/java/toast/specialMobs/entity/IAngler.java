...
/**
 * A mob must implement this interface to shoot EntitySpecialFishHook. This allows get and set methods for the fish hook
 * so that the entity and hook can keep track of each other.
 */
