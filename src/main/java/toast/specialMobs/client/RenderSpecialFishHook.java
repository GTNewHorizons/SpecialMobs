...
public class RenderSpecialFishHook extends Render {
    ...
    public void doRenderSpecialFishHook(EntitySpecialFishHook entity, double x, double y, double z, float f,
            float partialTicks) {
        GL11.glPushMatrix();
        ...
        if (entity.angler != null) {
            float swing = MathHelper
                    .sin(MathHelper.sqrt_float(entity.angler.getSwingProgress(partialTicks)) * (float) Math.PI);
            Vec3 vec;
            ...
            double d5 = entity.angler.prevPosX + (entity.angler.posX - entity.angler.prevPosX) * partialTicks
                    + vec.xCoord;
            double d6 = entity.angler.prevPosY + (entity.angler.posY - entity.angler.prevPosY) * partialTicks
                    + vec.yCoord;
            double d8 = entity.angler.prevPosZ + (entity.angler.posZ - entity.angler.prevPosZ) * partialTicks
                    + vec.zCoord;
